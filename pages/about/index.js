                ...
                <div className='container'>
                    <div className={styles.aboutWrapper}>
                        ...
                        <div className={styles.information}>
                            ...
                            <p className={styles.text}>Компания RIV RENT – надежный партнер по аренде автомобилей в Калининграде. Огромный спектр услуг и дополнений к аренде наших автомобилей, чтобы сделать ваше путешествие или деловую поездку максимально комфортной.</p>
