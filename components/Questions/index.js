...
const array = [
  ...
  { questions: 'Какой суточный пробег?', answer: 'Суточный пробег составляет от 200 до 300 км в зависимости от марки автомобиля.' },
  ...
  { questions: 'Можно ли получить автомобиль в ночное время?', answer: 'Да, мы осуществляем доставку наших транспортных средств круглосуточно. Дополнительно к стандартному тарифу за доставку во вне рабочее время оплачивается 1000 рублей.' },
  ...
  { questions: 'Включена ли страховка в тариф проката?', answer: 'Да, стоимость аренды автомобиля включает страхование гражданской ответственности.' },
]
